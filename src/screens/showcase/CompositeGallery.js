// Info: Composite gallery. Iterates the live registry's composite bucket —
// multi-part components that coordinate children through compound contexts
// (Tabs, Accordion, Menu, etc.). Each renders in a labelled, error-isolated
// card; composites that need specific child shapes degrade to a fallback.
