...
module.exports = {
  ...
  meta: {
    ...
    'color.APP_PRIMARY_HOVERED': { group: 'colour' },
    'color.APP_PRIMARY_PRESSED': { group: 'colour' },
    'color.APP_PRIMARY_FOCUSED': { group: 'colour' },
    'color.APP_PRIMARY_DISABLED': { group: 'colour' },
    ...
    'color.STATUS_INFO_SUBTLE': { group: 'colour' },
